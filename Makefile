...
pkgdatadir = $(datadir)/dbmaster
pkgincludedir = $(includedir)/dbmaster
pkglibdir = $(libdir)/dbmaster
pkglibexecdir = $(libexecdir)/dbmaster
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(nobase_dist_conf_DATA) \
	$(nobase_dist_pkgdata_DATA) $(am__DIST_COMMON)
am__CONFIG_DISTCLEAN_FILES = config.status config.cache config.log \
 configure.lineno config.status.lineno
mkinstalldirs = $(install_sh) -d
CONFIG_CLEAN_FILES = dbmaster dbmaster.service rc.d/dbmaster \
	init.d/dbmaster
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/dbmaster.pl \
	$(srcdir)/dbmaster.service.in $(top_srcdir)/init.d/dbmaster.in \
	$(top_srcdir)/rc.d/dbmaster.in config.guess config.sub \
	install-sh missing
...
ACLOCAL = ${SHELL} /home/ziggi/projects/dbmaster/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APP_CONFDIR = /usr/local/etc/dbmaster
APP_DATADIR = /var/dbmaster
APP_GROUP = www
APP_LIBDIR = /usr/local/share/dbmaster
APP_LOGDIR = /var/log/dbmaster
APP_RUNDIR = /var/run/dbmaster
APP_USER = www
AUTOCONF = ${SHELL} /home/ziggi/projects/dbmaster/missing autoconf
AUTOHEADER = ${SHELL} /home/ziggi/projects/dbmaster/missing autoheader
AUTOMAKE = ${SHELL} /home/ziggi/projects/dbmaster/missing automake-1.15
AWK = gawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"dbmaster.pl\" -DPACKAGE_TARNAME=\"dbmaster-pl\" -DPACKAGE_VERSION=\"0.01\" -DPACKAGE_STRING=\"dbmaster.pl\ 0.01\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"dbmaster-pl\" -DVERSION=\"0.01\" -DAPP_CONFDIR=\"/usr/local/etc/dbmaster\" -Dapp_confdir=\"/usr/local/etc/dbmaster\" -DAPP_LOGDIR=\"/var/log/dbmaster\" -Dapp_logdir=\"/var/log/dbmaster\" -DAPP_RUNDIR=\"/var/run/dbmaster\" -Dapp_rundir=\"/var/run/dbmaster\" -DAPP_USER=\"www\" -Dapp_user=\"www\" -DAPP_GROUP=\"www\" -Dapp_group=\"www\" -DAPP_LIBDIR=/usr/local/share/dbmaster -Dapp_libdir=/usr/local/share/dbmaster -DAPP_DATADIR=\"/var/dbmaster\" -Dapp_datadir=\"/var/dbmaster\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
HAVE_PERL = true
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ziggi/projects/dbmaster/missing makeinfo
MKDIR_P = /usr/local/bin/gmkdir -p
PACKAGE = dbmaster
PACKAGE_BUGREPORT = 
PACKAGE_NAME = dbmaster.pl
PACKAGE_STRING = dbmaster.pl 0.01
PACKAGE_TARNAME = dbmaster-pl
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.01
abs_builddir = /home/ziggi/projects/dbmaster
abs_srcdir = /home/ziggi/projects/dbmaster
abs_top_builddir = /home/ziggi/projects/dbmaster
abs_top_srcdir = /home/ziggi/projects/dbmaster
am__leading_dot = .
...
install_sh = ${SHELL} /home/ziggi/projects/dbmaster/install-sh
...
#nobase_systemd_DATA = dbmaster.service
sbin_SCRIPTS = dbmaster
confdir = /usr/local/etc/dbmaster
nobase_dist_conf_DATA = dbmaster.pw.example dbmaster.crt.example dbmaster.key.example
...
$(am__aclocal_m4_deps):
dbmaster: $(top_builddir)/config.status $(srcdir)/dbmaster.pl
	cd $(top_builddir) && $(SHELL) ./config.status $@
dbmaster.service: $(top_builddir)/config.status $(srcdir)/dbmaster.service.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
rc.d/dbmaster: $(top_builddir)/config.status $(top_srcdir)/rc.d/dbmaster.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
init.d/dbmaster: $(top_builddir)/config.status $(top_srcdir)/init.d/dbmaster.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
