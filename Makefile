...
##am__append_1 = rc.d/dbmaster
#am__append_2 = dbmaster.service
#am__append_3 = dbmaster
#am__append_4 = dbmaster.pw.example dbmaster.crt.example dbmaster.key.example
subdir = .
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/pgstore.pl $(srcdir)/pgagent.pl \
	$(srcdir)/dbmaster.pl $(top_srcdir)/rc.d/pgagent.in \
	$(top_srcdir)/rc.d/pgstore.in $(top_srcdir)/rc.d/dbmaster.in \
	$(srcdir)/pgagent.service.in $(srcdir)/pgstore.service.in \
	$(srcdir)/dbmaster.service.in \
	$(am__nobase_dist_conf_DATA_DIST) \
	$(am__nobase_dist_pkgdata_DATA_DIST) config.guess config.sub \
	install-sh missing
...
CONFIG_CLEAN_FILES = pgstore pgagent dbmaster rc.d/pgagent \
	rc.d/pgstore rc.d/dbmaster pgagent.service pgstore.service \
	dbmaster.service
...
am__nobase_dist_conf_DATA_DIST = pgagent.pw.example pgstore.pw.example \
	...
	pgstore.key.example dbmaster.pw.example dbmaster.crt.example \
	dbmaster.key.example
am__nobase_dist_pkgdata_DATA_DIST = dbmaster.sql public/css/app.css \
...
ACLOCAL = ${SHELL} /home/ziggi/pgdumper/head/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /home/ziggi/pgdumper/head/missing automake-1.14
AWK = mawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"pgdumper\" -DPACKAGE_TARNAME=\"pgdumper\" -DPACKAGE_VERSION=\"0.01\" -DPACKAGE_STRING=\"pgdumper\ 0.01\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"pgdumper\" -DVERSION=\"0.01\" -DAPP_CONFDIR=\"/usr/local/etc/pgdumper\" -DAPP_LOGDIR=\"/var/log/pgdumper\" -DAPP_RUNDIR=\"/var/run/pgdumper\" -DPGSTORE_DATADIR=\"/var/pgstore\" -DAPP_USER=\"www-data\" -DAPP_GROUP=\"www-data\" -DAPP_LIBDIR=/usr/local/share/pgdumper -DAPP_EXECDIR=/usr/local/sbin
ECHO_C = 
ECHO_N = -n
ECHO_T = 
HAVE_PERL = true
