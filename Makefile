...
subdir = .
DIST_COMMON = $(am__configure_deps) $(am__nobase_dist_conf_DATA_DIST) \
	$(am__nobase_dist_pkgdata_DATA_DIST) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/pgagent.pl \
	$(srcdir)/pgagent.service.in $(srcdir)/pgmaster.pl \
	$(srcdir)/pgmaster.service.in $(srcdir)/pgstore.pl \
	$(srcdir)/pgstore.service.in $(top_srcdir)/configure \
	$(top_srcdir)/rc.d/pgagent.in $(top_srcdir)/rc.d/pgmaster.in \
	$(top_srcdir)/rc.d/pgstore.in config.guess config.sub \
	install-sh missing
...
ACLOCAL = ${SHELL} /home/ziggi/pmm2/mojoapps/pgdumper/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
...
APP_USER = www
AUTOCONF = ${SHELL} /home/ziggi/pmm2/mojoapps/pgdumper/missing --run autoconf
AUTOHEADER = ${SHELL} /home/ziggi/pmm2/mojoapps/pgdumper/missing --run autoheader
AUTOMAKE = ${SHELL} /home/ziggi/pmm2/mojoapps/pgdumper/missing --run automake-1.12
AWK = gawk
CYGPATH_W = echo
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ziggi/pmm2/mojoapps/pgdumper/missing --run makeinfo
...
STRIP = 
VERSION = 0.01
abs_builddir = /home/ziggi/pmm2/mojoapps/pgdumper
abs_srcdir = /home/ziggi/pmm2/mojoapps/pgdumper
abs_top_builddir = /home/ziggi/pmm2/mojoapps/pgdumper
abs_top_srcdir = /home/ziggi/pmm2/mojoapps/pgdumper
am__leading_dot = .
...
install_sh = ${SHELL} /home/ziggi/pmm2/mojoapps/pgdumper/install-sh
...
.PHONY: all all-am am--refresh check check-am clean clean-generic dist \
	...
	install-nobase_dist_confDATA install-nobase_dist_pkgdataDATA \
