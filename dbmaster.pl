...
sub agent_add {
    my $self = shift;
    $self->render(template => 'agent_add');
}

sub agent_config {
    my $self = shift;
    $self->render(template => 'agent_config');
}

sub agent_delete {
    my $self = shift;
    $self->render(template => 'agent_delete');
}

sub agent_db_list {
    my $self = shift;
    my $id = $self->req->param('id');
    $self->render(template => 'agent_db_list');
}

sub agent_db_create {
    my $self = shift;
    $self->render(template => 'agent_db_create');
}

sub agent_db_drop {
    my $self = shift;
    $self->render(template => 'agent_db_drop');
}

sub agent_db_rename {
    my $self = shift;
    $self->render(template => 'agent_db_rename');
}

sub agent_db_copy {
    my $self = shift;
    $self->render(template => 'agent_db_copy');
}

sub agent_db_dump {
    my $self = shift;
    $self->render(template => 'agent_db_dump');
}

sub agent_db_restore {
    my $self = shift;
    $self->render(template => 'agent_db_restore');
}
...
sub store_add {
    my $self = shift;
    $self->render(template => 'store_add');
}

sub store_config {
    my $self = shift;
    $self->render(template => 'store_config');
}

sub store_delete {
    my $self = shift;
    $self->render(template => 'store_delete');
}

sub store_data_list {
    my $self = shift;
    $self->render(template => 'store_data_list');
}

sub store_data_delete {
    my $self = shift;
    $self->render(template => 'store_data_delete');
}

sub store_data_download {
    my $self = shift;
    $self->render(template => 'store_data_download');
}
...
sub data_list {
    my $self = shift;
    $self->render(template => 'data_list');
}
...
sub schedule_list {
    my $self = shift;
    $self->render(template => 'schedule_list');
}

sub schedule_add {
    my $self = shift;
    $self->render(template => 'schedule_add');
}

sub schedule_delete {
    my $self = shift;
    $self->render(template => 'schedule_delete');
}

sub schedule_config {
    my $self = shift;
    $self->render(template => 'schedule_config');
}
...
$app->helper(
    model => sub {
        my $db = DBmaster::DB->new(
                        hostname => $app->config("dbhost"),
                        username => $app->config("dbuser"),
                        password => $app->config("dbpwd"),
                        database => $app->config("dbname"),
        );
        state $model = DBmaster::Model->new($app, $db);
    }
);

$app->helper(
    cron => sub {
        state $cron = DBmaster::Cron->new($app);
});
